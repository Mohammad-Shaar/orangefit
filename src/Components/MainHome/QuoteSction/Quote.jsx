...
const Quote = () => {
  ...
  const { weightLossText, motivation, advice } = t("quoteSection");
  ...
  return (
    <section className="rounded-2xl bg-gradient-to-r from-[#FF6400] via-[#FF6400] to-[#FE8E22]">
      <div className="container flex flex-col items-center justify-between mx-auto p-6 py-10 text-gray-50 md:flex-row">
        <div>
          <p className="font-semibold text-4xl text-center leading-[47px] mt-10 mb-5 md:text-6xl md:leading-[70px] md:text-start md:my-10">
            &quot;95%
            <Trans
              i18nKey={weightLossText}
              components={{ 1: <span className="font-light" /> }}
            />
            &quot;
          </p>
